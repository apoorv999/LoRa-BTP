...
void sendData(){
  ...
  String url = "/api/insert.php?lat=" + lati + "&lon=" + longi + "&turbidity=" + turbidity;
...
void LoRaData(){
 ...
 while ((str = strtok_r(p, ":", &p)) != NULL){ // delimiter is the semicolon
   switch(i){
    ...
    case 2: Heltec.display->drawString(50 , 30 , str);longi=str;break;
    default: Heltec.display->drawString(50 , 40 , str);turbidity=str;
   }
   i++;
}
  sendData(); 
